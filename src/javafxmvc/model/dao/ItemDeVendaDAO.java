...
/*classe para inserir deletar alterar registro da venda exemplo quantidade de produtos 
valor total e cd dos produtos cd da venda, no banco de dados*/
public class ItemDeVendaDAO {
    ...
    public boolean inserir(ItemDeVenda itemDeVenda) {
        ...
        try {
            ...
            stmt.setString(3, itemDeVenda.getProduto().getCdProduto());
